...
{{- printf "server=%s-mysql.%s.svc.cluster.local;uid=%s;pwd=%s;database=%s" .Release.Name .Release.Namespace $user $pwd $name }}
{{- else}}
...
{{- printf "http://%s-seq.%s.svc.cluster.local:5341" .Release.Name .Release.Namespace }}
{{- end }}
...
{{- printf "%s-redis.%s.svc.cluster.local:6379" .Release.Name .Release.Namespace }}
{{- end }}
